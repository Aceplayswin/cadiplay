...
-- ---------------------------------------------------------------------------
DROP PROCEDURE IF EXISTS _cadiplay_drop_fk;
DROP PROCEDURE IF EXISTS _cadiplay_add_fk;
DELIMITER $$
...
-- a different number.
CREATE PROCEDURE _cadiplay_drop_fk(IN tbl VARCHAR(64), IN col VARCHAR(64))
BEGIN
...
CREATE PROCEDURE _cadiplay_add_fk(
